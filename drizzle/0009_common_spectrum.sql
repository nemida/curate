ALTER TABLE "notes" RENAME TO "blogs";--> statement-breakpoint
ALTER TABLE "blogs" DROP CONSTRAINT "notes_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "reading_list" DROP CONSTRAINT "reading_list_blog_id_notes_id_fk";
--> statement-breakpoint
